        ...
        Padding(
          ...
          child: GestureDetector(
            ...
            child: const Icon(
              Icons.arrow_back,
              color: Colors.white,
              shadows: [Shadow(color: Colors.yellowAccent, blurRadius: 2)],
            ),
          ),
        )
      ],
        ...
        Column(
          children: [
            IconButton(
                ...
                icon: const Icon(Icons.arrow_upward, color: Colors.blueGrey,shadows: [Shadow(color: Colors.purpleAccent, blurRadius: 2)],)),

            IconButton(
                onPressed: () {
                 shoppingController.quitarProducto(product.id);
                },
                icon: const Icon(Icons.arrow_downward, color: Colors.blueGrey, shadows: [Shadow(color: Colors.purpleAccent, blurRadius: 2)],))
          ],
        ),
        Column(
          children: [
